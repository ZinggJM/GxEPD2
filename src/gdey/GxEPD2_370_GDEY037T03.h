...
#ifndef _GxEPD2_370_GDEY037T03_H_
#define _GxEPD2_370_GDEY037T03_H_

#include "../GxEPD2_EPD.h"

class GxEPD2_370_GDEY037T03 : public GxEPD2_EPD
{
  public:
    // attributes
    ...
    static const bool useFastFullUpdate = true; // set false for extended (low) temperature range, 1005000us vs 2950000us
    static const uint16_t power_on_time = 50; // ms, e.g. 46000us
    static const uint16_t power_off_time = 50; // ms, e.g. 40000us
    static const uint16_t full_refresh_time = 1500; // ms, e.g. 1005000us or 1486000us
    static const uint16_t partial_refresh_time = 350; // ms, e.g. 343000us
    // constructor
    GxEPD2_370_GDEY037T03(int16_t cs, int16_t dc, int16_t rst, int16_t busy);
    // methods (virtual)
