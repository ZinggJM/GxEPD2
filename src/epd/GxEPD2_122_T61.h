#ifndef _GxEPD2_122_T61_H_
#define _GxEPD2_122_T61_H_

#include "../GxEPD2_EPD.h"

class GxEPD2_122_T61 : public GxEPD2_EPD
{
  public:
    // attributes
    static const uint16_t WIDTH = 192;
    static const uint16_t WIDTH_VISIBLE = WIDTH;
    static const uint16_t HEIGHT = 176;
    static const GxEPD2::Panel panel = GxEPD2::GDEM0122T61;
    static const bool hasColor = false;
    static const bool hasPartialUpdate = true;
    static const bool hasFastPartialUpdate = false;
    static const bool useFastFullUpdate = false; // set false for extended (low) temperature range
    ...
    static const uint16_t partial_refresh_time = 300; // ms, e.g. 459000us
    // constructor
    GxEPD2_122_T61(int16_t cs, int16_t dc, int16_t rst, int16_t busy);
    // methods (virtual)
