...
// Panel: GDEP0150BN : https://www.dke.top/products/dke-154-inch-small-display-modules-epd152x152-electronic-e-ink-paper-displays
...
class GxEPD2_150_BN : public GxEPD2_EPD
{
  public:
    ...
    static const GxEPD2::Panel panel = GxEPD2::GDEP0150BN;
