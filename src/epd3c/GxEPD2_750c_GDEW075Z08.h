...
#ifndef _GxEPD2_750c_GDEW075Z08_H_
#define _GxEPD2_750c_GDEW075Z08_H_

#include "../GxEPD2_EPD.h"

class GxEPD2_750c_GDEW075Z08 : public GxEPD2_EPD
{
  public:
    // attributes
    ...
    static const uint16_t power_on_time = 150; // ms, e.g. 139001us
    static const uint16_t power_off_time = 30; // ms, e.g. 25001us
    static const uint16_t full_refresh_time = 18000; // ms, e.g. 17141001us
    static const uint16_t partial_refresh_time = 18000; // ms, e.g. 17141001us
    // constructor
    GxEPD2_750c_GDEW075Z08(int16_t cs, int16_t dc, int16_t rst, int16_t busy);
    // methods (virtual)
