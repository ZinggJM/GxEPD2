...
#ifndef _GxEPD2_266_SESc_H_
#define _GxEPD2_266_SESc_H_

#include "../GxEPD2_EPD.h"

class GxEPD2_266_SESc : public GxEPD2_EPD
{
public:
    // attributes
    ...
    static const GxEPD2::Panel panel           = GxEPD2::FE2266FS094;
    ...
    // constructor
    GxEPD2_266_SESc(int16_t cs, int16_t dc, int16_t rst, int16_t busy);
    // methods (virtual)
