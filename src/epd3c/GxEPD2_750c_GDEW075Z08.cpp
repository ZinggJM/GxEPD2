...
#include "GxEPD2_750c_GDEW075Z08.h"

GxEPD2_750c_GDEW075Z08::GxEPD2_750c_GDEW075Z08(int16_t cs, int16_t dc, int16_t rst, int16_t busy) :
  GxEPD2_EPD(cs, dc, rst, busy, LOW, 20000000, WIDTH, HEIGHT, panel, hasColor, hasPartialUpdate, hasFastPartialUpdate)
{
}

void GxEPD2_750c_GDEW075Z08::clearScreen(uint8_t value)
{
  clearScreen(value, 0xFF);
}

void GxEPD2_750c_GDEW075Z08::clearScreen(uint8_t black_value, uint8_t color_value)
{
  writeScreenBuffer(black_value, color_value);
  refresh(false);
}

void GxEPD2_750c_GDEW075Z08::writeScreenBuffer(uint8_t value)
{
  writeScreenBuffer(value, 0xFF);
}

void GxEPD2_750c_GDEW075Z08::writeScreenBuffer(uint8_t black_value, uint8_t color_value)
{
...
void GxEPD2_750c_GDEW075Z08::_writeScreenBuffer(uint8_t command, uint8_t value)
{
...
void GxEPD2_750c_GDEW075Z08::_writeImage(uint8_t command, const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_750c_GDEW075Z08::writeImageToPrevious(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  _writeImage(0x13, bitmap, x, y, w, h, invert, mirror_y, pgm);
}

void GxEPD2_750c_GDEW075Z08::writeImageToCurrent(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  _writeImage(0x10, bitmap, x, y, w, h, invert, mirror_y, pgm);
}

void GxEPD2_750c_GDEW075Z08::writeImagePart(const uint8_t bitmap[], int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  _writeImagePart(0x10, bitmap, x_part, y_part, w_bitmap, h_bitmap, x, y, w, h, invert, mirror_y, pgm);
}

void GxEPD2_750c_GDEW075Z08::_writeImagePart(uint8_t command, const uint8_t bitmap[], int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  if (_initial_write) writeScreenBuffer(); // initial full screen buffer clean
  delay(1); // yield() to avoid WDT on ESP8266 and ESP32
...
void GxEPD2_750c_GDEW075Z08::writeImage(const uint8_t* black, const uint8_t* color, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  if (black) _writeImage(0x10, black, x, y, w, h, invert, mirror_y, pgm);
  if (color) _writeImage(0x13, color, x, y, w, h, invert, mirror_y, pgm);
}

void GxEPD2_750c_GDEW075Z08::writeImagePart(const uint8_t* black, const uint8_t* color, int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_750c_GDEW075Z08::drawImage(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  writeImage(bitmap, x, y, w, h, invert, mirror_y, pgm);
  refresh(x, y, w, h);
}

void GxEPD2_750c_GDEW075Z08::drawImagePart(const uint8_t bitmap[], int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_750c_GDEW075Z08::drawImage(const uint8_t* black, const uint8_t* color, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  writeImage(black, color, x, y, w, h, invert, mirror_y, pgm);
  refresh(x, y, w, h);
}

void GxEPD2_750c_GDEW075Z08::drawImagePart(const uint8_t* black, const uint8_t* color, int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_750c_GDEW075Z08::drawNative(const uint8_t* data1, const uint8_t* data2, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  writeNative(data1, data2, x, y, w, h, invert, mirror_y, pgm);
  refresh(x, y, w, h);
}

void GxEPD2_750c_GDEW075Z08::refresh(bool partial_update_mode)
{
  if (partial_update_mode) refresh(0, 0, WIDTH, HEIGHT);
  else _Update_Full();
}

void GxEPD2_750c_GDEW075Z08::refresh(int16_t x, int16_t y, int16_t w, int16_t h)
{
...
void GxEPD2_750c_GDEW075Z08::powerOff()
{
  _PowerOff();
}

void GxEPD2_750c_GDEW075Z08::hibernate()
{
  _PowerOff();
  if (_rst >= 0)
  {
...
void GxEPD2_750c_GDEW075Z08::_setPartialRamArea(uint16_t x, uint16_t y, uint16_t w, uint16_t h)
{
...
void GxEPD2_750c_GDEW075Z08::_PowerOn()
{
  if (!_power_is_on)
  {
    _writeCommand(0x04);
...
void GxEPD2_750c_GDEW075Z08::_PowerOff()
{
  if (_power_is_on)
  {
...
void GxEPD2_750c_GDEW075Z08::_InitDisplay()
{
...
void GxEPD2_750c_GDEW075Z08::_Update_Full()
{
  _writeCommand(0x00); // PANEL SETTING
  _writeData(0x0f);    // KW: 3f, KWR: 2F, BWROTP: 0f, BWOTP: 1f
  _writeCommand(0x50); // VCOM AND DATA INTERVAL SETTING
...
void GxEPD2_750c_GDEW075Z08::_Update_Part()
{
  _writeCommand(0x00); // PANEL SETTING
  _writeData(0x0f);    // KW: 3f, KWR: 2F, BWROTP: 0f, BWOTP: 1f
  _writeCommand(0x50); // VCOM AND DATA INTERVAL SETTING
...
#define T_BW 40
#define T_WB 40
const unsigned char GxEPD2_750c_GDEW075Z08::lut_20_LUTC_partial[] PROGMEM =
{
  //0x00, T_BW, T_WB, 0, 0, 1,
  // from GxEPD2_750c_GDEY075Z08: GDEY075Z08 OTP
...
const unsigned char GxEPD2_750c_GDEW075Z08::lut_21_LUTWW_partial[] PROGMEM =
{ // 10 w
  //0x00, T_BW, T_WB, 0, 0, 1,
  // from GxEPD2_750c_GDEY075Z08: GDEY075Z08 OTP
  0x0, 0x3, 0x5, 0x0, 0x0, 0x2,
...
const unsigned char GxEPD2_750c_GDEW075Z08::lut_22_LUTKW_partial[] PROGMEM =
{ // 10 w
  //0x80, T_BW, T_WB, 0, 0, 1,
  // from GxEPD2_750c_GDEY075Z08: GDEY075Z08 OTP
...
const unsigned char GxEPD2_750c_GDEW075Z08::lut_23_LUTWK_partial[] PROGMEM =
{ // 01 b
  //0x40, T_BW, T_WB, 0, 0, 1,
  // from GxEPD2_750c_GDEY075Z08: GDEY075Z08 OTP
...
const unsigned char GxEPD2_750c_GDEW075Z08::lut_24_LUTKK_partial[] PROGMEM =
{ // 01 b
  //0x00, T_BW, T_WB, 0, 0, 1,
  // from GxEPD2_750c_GDEY075Z08: GDEY075Z08 OTP
  0x0, 0x3, 0x5, 0x0, 0x0, 0x2,
...
const unsigned char GxEPD2_750c_GDEW075Z08::lut_25_LUTBD_partial[] PROGMEM =
{
  //0x00, T_BW, T_WB, 0, 0, 1,
};

void GxEPD2_750c_GDEW075Z08::refresh_bw(int16_t x, int16_t y, int16_t w, int16_t h)
{
  x -= x % 8; // byte boundary
  w -= w % 8; // byte boundary
  int16_t x1 = x < 0 ? 0 : x; // limit
  ...
  _writeData (0x2F);   // -2.45V same value as in OTP
  _writeCommand(0x50); // VCOM AND DATA INTERVAL SETTING
  _writeData(0x10);
  _writeData(0x07);
  _writeCommand(0x20);
