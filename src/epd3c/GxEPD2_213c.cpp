...
GxEPD2_213c::GxEPD2_213c(int8_t cs, int8_t dc, int8_t rst, int8_t busy) : GxEPD2_EPD(cs, dc, rst, busy, LOW, 20000000)
{
  _initial = true;
  _power_is_on = false;
}

void GxEPD2_213c::init(uint32_t serial_diag_bitrate)
{
