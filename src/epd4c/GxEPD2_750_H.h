...
class GxEPD2_750_H : public GxEPD2_EPD
{
  public:
    // attributes
    ...
    static const GxEPD2::Panel panel = GxEPD2::Waveshare_7_5_bwry;
    ...
    static const uint16_t full_refresh_time = 22000; // ms, e.g. 12709000us
    static const uint16_t partial_refresh_time = 22000; // ms, e.g. 12709000us
    // constructor
    GxEPD2_750_H(int16_t cs, int16_t dc, int16_t rst, int16_t busy);
    // methods (virtual)
