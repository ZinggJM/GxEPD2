...
//
// based on Demo Example from Good Display: https://www.good-display.com/comp/xcompanyFile/downloadNew.do?appId=24&fid=2328&id=1704
// Panel: GDEM0397F81 : https://www.good-display.com/product/577.html
...
#include "GxEPD2_397c_GDEM0397F81.h"

GxEPD2_397c_GDEM0397F81::GxEPD2_397c_GDEM0397F81(int16_t cs, int16_t dc, int16_t rst, int16_t busy) :
...
void GxEPD2_397c_GDEM0397F81::selectFastFullUpdate(bool ff)
{
...
void GxEPD2_397c_GDEM0397F81::clearScreen(uint8_t value)
{
  clearScreen(value, 0xFF);
}

void GxEPD2_397c_GDEM0397F81::clearScreen(uint8_t black_value, uint8_t color_value)
{
  writeScreenBuffer(black_value, color_value);
  refresh();
}

void GxEPD2_397c_GDEM0397F81::writeScreenBuffer(uint8_t value)
{
  writeScreenBuffer(value, 0xFF);
}

void GxEPD2_397c_GDEM0397F81::writeScreenBuffer(uint8_t black_value, uint8_t color_value)
{
...
void GxEPD2_397c_GDEM0397F81::writeImage(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_397c_GDEM0397F81::writeImage(const uint8_t* black, const uint8_t* color, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_397c_GDEM0397F81::writeImagePart(const uint8_t bitmap[], int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
...
void GxEPD2_397c_GDEM0397F81::writeImagePart(const uint8_t* black, const uint8_t* color, int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  //Serial.print("writeImagePart("); Serial.print(x_part); Serial.print(", "); Serial.print(y_part); Serial.print(", ");
  //Serial.print(w_bitmap); Serial.print(", "); Serial.print(h_bitmap); Serial.print(", ");
...
void GxEPD2_397c_GDEM0397F81::writeNative(const uint8_t* data1, const uint8_t* data2, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  if (!data1) return;
...
void GxEPD2_397c_GDEM0397F81::writeNativePart(const uint8_t* data1, const uint8_t* data2, int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  if (!data1) return;
  delay(1); // yield() to avoid WDT on ESP8266 and ESP32
...
void GxEPD2_397c_GDEM0397F81::drawImage(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  writeImage(bitmap, x, y, w, h, invert, mirror_y, pgm);
  refresh(x, y, w, h);
}

void GxEPD2_397c_GDEM0397F81::drawImagePart(const uint8_t bitmap[], int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_397c_GDEM0397F81::drawImage(const uint8_t* black, const uint8_t* color, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  writeImage(black, color, x, y, w, h, invert, mirror_y, pgm);
  refresh(x, y, w, h);
}

void GxEPD2_397c_GDEM0397F81::drawImagePart(const uint8_t* black, const uint8_t* color, int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_397c_GDEM0397F81::drawNative(const uint8_t* data1, const uint8_t* data2, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  writeNative(data1, data2, x, y, w, h, invert, mirror_y, pgm);
  refresh(x, y, w, h);
}

void GxEPD2_397c_GDEM0397F81::refresh(bool partial_update_mode)
{
  if (hasPartialUpdate) _setPartialRamArea(0, 0, WIDTH, HEIGHT);
  _refresh(partial_update_mode);
}

void GxEPD2_397c_GDEM0397F81::refresh(int16_t x, int16_t y, int16_t w, int16_t h)
{
...
void GxEPD2_397c_GDEM0397F81::powerOff()
{
  _PowerOff();
}

void GxEPD2_397c_GDEM0397F81::hibernate()
{
  _PowerOff();
  if (_rst >= 0)
  {
...
void GxEPD2_397c_GDEM0397F81::setPaged()
{
  if (!hasPartialUpdate)
  {
    _paged = true;
...
void GxEPD2_397c_GDEM0397F81::_refresh(bool partial_update_mode)
{
...
void GxEPD2_397c_GDEM0397F81::_setPartialRamArea(uint16_t x, uint16_t y, uint16_t w, uint16_t h, bool partial_mode)
{
...
void GxEPD2_397c_GDEM0397F81::_PowerOn()
{
  if (!_power_is_on)
  {
    _writeCommand(0x04);
...
void GxEPD2_397c_GDEM0397F81::_PowerOff()
{
  if (_power_is_on)
  {
    _writeCommand(0x02);
...
void GxEPD2_397c_GDEM0397F81::_InitDisplay()
{
  if ((_rst >= 0) && (_hibernating || _initial_write))
  {
    ...
    //_waitWhileBusy("_InitDisplay reset", power_on_time); // 6000us measured
    delay(10); // At least 10ms delay
    _hibernating = false;
    _power_is_on = false;
  }
  if (_initial_write) delay(20);
  _writeCommand(0x00); // 0x00 // PSR
  _writeData(0x2B);
  _writeData(0x29);
  _writeCommand(0x06); // 0x06 // PWRR
  _writeData(0x0F);
  _writeData(0x8B);
  _writeData(0x93);
  _writeData(0xC1); // 0xC1
  _writeCommand(0x50); // 0x50 // CDI
  _writeData(0x37);
  _writeCommand(0x30); // 0x30 // PLL
  _writeData(0x08);
  _writeCommand(0x61); //TRES
  _writeData(WIDTH / 256); // Source_BITS_H
  _writeData(WIDTH % 256); // Source_BITS_L
  //  _writeData(HEIGHT / 256); // Gate_BITS_H // doesn't work, reason unknown
  //  _writeData(HEIGHT % 256); // Gate_BITS_L // doesn't work, reason unknown
  _writeData(680 / 256); // Gate_BITS_H // as in demo code, works
  _writeData(680 % 256); // Gate_BITS_L // as in demo code, works
  _writeCommand(0x62);
  _writeData(0x76);
  _writeData(0x76);
  _writeData(0x76);
  ...
  _writeData(0x76);
  _writeData(0x62);
  _writeCommand(0x65); //0x65 // GSST
  _writeData(0x00);
  _writeData(0x00);
  _writeData(0x00);
  _writeData(0x00);
  _writeCommand(0xE0); //0xE3 // PWS
  _writeData(0x10);
  _writeCommand(0xE7); //0xE7 // PST
  _writeData(0xA4);
  _writeCommand(0xE9);
  _writeData(0x01);
  if (_use_fast_update)
...
uint8_t GxEPD2_397c_GDEM0397F81::_invert(uint8_t data)
{
  uint8_t result = 0x00;
  for (int i = 0; i < 4; i++)
  {
