...
#ifndef _GxEPD2_397c_GDEM0397F81_H_
#define _GxEPD2_397c_GDEM0397F81_H_

#include "../GxEPD2_EPD.h"

class GxEPD2_397c_GDEM0397F81 : public GxEPD2_EPD
{
  public:
    // attributes
    ...
    static const GxEPD2::Panel panel = GxEPD2::GDEM0397F81;
    ...
    static const uint16_t full_refresh_time = 22000; // ms, e.g. 21860001us
    static const uint16_t partial_refresh_time = 22000; // ms, e.g. 21860001us
    // constructor
    GxEPD2_397c_GDEM0397F81(int16_t cs, int16_t dc, int16_t rst, int16_t busy);
    // methods (virtual)
