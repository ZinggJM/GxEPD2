...
void GxEPD2_1085_GDEM1085T51::_InitDisplay()
{
  ...
  //_writeDataToBoth(0x8F);
  _writeDataToBoth(0x9F); //otp
  _writeDataToBoth(0x4D);
  _writeCommandToBoth(0x06);//boost
  _writeDataToBoth(0x57);
  _writeDataToBoth(0x24);
  _writeDataToBoth(0x28);
  _writeDataToBoth(0x32);
  _writeDataToBoth(0x08);
  _writeDataToBoth(0x48);
  _writeCommandToBoth(0x61);//resolution setting
  _writeDataToBoth(0X02);//680   1360*480
  _writeDataToBoth(0XA8);
  _writeDataToBoth(0X01);//480
  _writeDataToBoth(0XE0);
  _writeCommandToBoth(0x62);
  _writeDataToBoth(0x00);
  _writeDataToBoth(0x00);
  _writeDataToBoth(0x00);
  _writeDataToBoth(0x00);
  _writeCommandToBoth(0x60);
  _writeDataToBoth(0x31);
  _writeCommandToBoth(0x50);//VCOM and DATA interval setting(CDI)
  _writeDataToBoth(0x77);
  ...
  _power_is_on = true;
#else
  // from bad GDEM1085T51 demo
  _writeCommand(0xF8);  // Enter FITI Command
  _writeData(0x7C);
  _writeData(0x00);
  _writeCommand(0xF8);  // Enter FITI Command
  _writeData(0x60);
...
const unsigned char GxEPD2_1085_GDEM1085T51::lut_20_vcomDC[] PROGMEM =
{
...
const unsigned char GxEPD2_1085_GDEM1085T51::lut_21_ww[] PROGMEM =
{
...
const unsigned char GxEPD2_1085_GDEM1085T51::lut_22_bw[] PROGMEM =
{
...
const unsigned char GxEPD2_1085_GDEM1085T51::lut_23_wb[] PROGMEM =
{
...
const unsigned char GxEPD2_1085_GDEM1085T51::lut_24_bb[] PROGMEM =
{
...
const unsigned char GxEPD2_1085_GDEM1085T51::lut_20_vcomDC_partial[] PROGMEM =
{
...
const unsigned char GxEPD2_1085_GDEM1085T51::lut_21_ww_partial[] PROGMEM =
{
  0x01, 0x04, 0x04, 0x03, 0x01, 0x01, 0x01,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
const unsigned char GxEPD2_1085_GDEM1085T51::lut_22_bw_partial[] PROGMEM =
{
...
const unsigned char GxEPD2_1085_GDEM1085T51::lut_23_wb_partial[] PROGMEM =
{
...
const unsigned char GxEPD2_1085_GDEM1085T51::lut_24_bb_partial[] PROGMEM =
{
  0x01, 0x04, 0x04, 0x03, 0x01, 0x01, 0x01,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
