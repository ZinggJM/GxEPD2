...
// in this version GxEPD2_154c can only be used with full size buffer (or with no buffer base display class)
//GxEPD2_3C<GxEPD2_154c, (GxEPD2_154c::HEIGHT> display(GxEPD2_154c(/*CS=10*/ SS, /*DC=*/ 8, /*RST=*/ 9, /*BUSY=*/ 7));
