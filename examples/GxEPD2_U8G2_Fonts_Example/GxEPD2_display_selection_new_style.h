...
//#define GxEPD2_DRIVER_CLASS GxEPD2_397_GDEM0397T81 // GDEM0397T81, 480x800, SSD1677, (FPC-7750)
...
//#define GxEPD2_DRIVER_CLASS GxEPD2_576_GDEH0576T81 // GDEH0576T81 920x680. SSD2677 (HINK-E0576A01-FPC-A1)
...
#define GxEPD2_BW_SHM_IS_GxEPD2_BW_SHM true
...
#define IS_GxEPD2_BW_SHM(x) IS_GxEPD(GxEPD2_BW_SHM_IS_, x)
...
#endif
#if IS_GxEPD2_BW(GxEPD2_DISPLAY_CLASS) || IS_GxEPD2_BW_SHM(GxEPD2_DISPLAY_CLASS)
