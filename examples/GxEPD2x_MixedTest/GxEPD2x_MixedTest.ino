...
void setup()
{
  ...
  else
  {
    ...
    Serial.print("current_bw_window  0x"); Serial.println(uint32_t(current_bw_window.getBuffer()));
    Serial.print("previous_bw_window 0x"); Serial.println(uint32_t(previous_bw_window.getBuffer()));
  }
  display.hibernate();
}
...
void showValue(uint16_t value)
{
  ...
  display.epd2.refresh_special_bw(window_x, window_y, window_width, window_height);
