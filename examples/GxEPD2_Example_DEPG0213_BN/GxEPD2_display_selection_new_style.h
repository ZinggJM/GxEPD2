...
/*
      QUESTO PROGRAMMA PROVA L'USO DELLA SCRITTURA E GRAFICA SU BADGE 2.1.3 B73 OLD
      IN ATTESA DEI DRIVER PER LA VERSIONE BN
...
#define GxEPD2_DRIVER_CLASS GxEPD2_213_BN // GDEH0213B73 128x250, SSD1675B
