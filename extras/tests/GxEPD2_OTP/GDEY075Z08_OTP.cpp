#include "GDEY075Z08_OTP.h"

#pragma GCC diagnostic ignored "-Wunused-variable"

void GDEY075Z08_OTP::check()
{
  //read_TSC();
  read_temperature();
  //  read_revision();
...
void GDEY075Z08_OTP::read_temperature()
{
...
void GDEY075Z08_OTP::read_revision()
{
...
void GDEY075Z08_OTP::read_status()
{
...
void GDEY075Z08_OTP::read_otp()
{
  ...
  Serial.println();
  for (int i = 0; i < 7; i++) // 10 temperature ranges, 7 used for 3-color
  {
    read_LUT(addr);
  }
  read_LUT_KW(addr); // one used for b/w, with different format
}

void GDEY075Z08_OTP::read_LUT_TR(int n)
{
  uint8_t value = 0;
...
void GDEY075Z08_OTP::read_LUT(uint16_t &addr)
{
  uint8_t value = 0;
...
void GDEY075Z08_OTP::read_LUT_KW(uint16_t &addr)
{
  uint8_t value = 0;
  uint16_t n = addr / (0x0140 - 0x0049); // 0x0049: @LUT_TR0, 0x140: @LUT_TR1
